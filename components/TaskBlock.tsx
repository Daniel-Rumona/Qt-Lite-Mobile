...
// import { TaskType } from '@/types'; // Assuming you have a type for TaskType
...
const TaskBlock = ({ taskList }: { taskList: TaskType[] }) => {
  const router = useRouter(); // Use the router for navigation

  const handleAddTask = () => {
    // Navigate to the Tasks page
    router.push('pages/Tasks'); // Assuming your Tasks.tsx page is inside pages/ directory
  };
